...
class Api:
    def __init__(self, app: FastAPI, queue_lock: Lock):
        ...
        # isolate this for now
        # the function of response_model is to validate the response
        ...
        self.add_api_route("/sdapi/v1/refresh-embeddings",
                           self.refresh_embeddings, methods=["POST"])
    ...
    def apply_infotext(self, request, tabname, *, script_runner=None, mentioned_script_args=None):
        ...
        set_fields = request.model_dump(exclude_unset=True) if hasattr(request, "request") else request.dict(
            exclude_unset=True)  # pydantic v1/v2 have differenrt names for this
        params = infotext_utils.parse_generation_parameters(request.infotext)

        def get_field_value(field, params):
            value = field.function(
                params) if field.function else params.get(field.label)
            if value is None:
                return None
        ...
        if script_runner is not None and mentioned_script_args is not None:
            ...
            script_fields = ((field, indexes[field.component])
                             for field in possible_fields if field.component in indexes)
    ...
    def text2imgapi(self, txt2imgreq: models.StableDiffusionTxt2ImgProcessingAPI):
        ...
        # populate updates the __init__ params of the object
        ...
        """
        args = vars(populate)
        below pops are used to remove any keys that are none
        """
        args = vars(populate)
        # this removes any script_name that is none
        ...
        # print(script_args, "the script args")
        # print(vars(script_runner), "the script runner")
